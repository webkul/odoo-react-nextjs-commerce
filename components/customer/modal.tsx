      ...
      >
        <div className="px-6 py-4">
          {isObject(session?.user) ? (
            <div className="min-w-60 max-w-80 border-none bg-transparent shadow-none">
              <div className="justify-between">
                <div className="flex gap-3">
                  ...
                  <div className="flex flex-col items-start justify-center">
                    <h4 className="text-small text-default-500 font-semibold leading-none dark:text-white">
                      {session?.user?.name}
                    </h4>
                    <h5 className="text-small text-default-500 tracking-tight dark:text-white">
                      {session?.user?.email}
                    </h5>
                  </div>
                </div>
              ...
              <div className="px-3 py-2">
                <p className="text-small text-default-500 pl-px dark:text-white">
                  Manage Cart, Orders
            ...
            <div className="min-w-80 border-none bg-transparent shadow-none">
              <div className="justify-between">
                <div className="flex gap-3">
                  <h4 className="text-default-600 text-xl font-semibold leading-none dark:text-white">
                    Welcome Guest
                  </h4>
                </div>
              </div>
